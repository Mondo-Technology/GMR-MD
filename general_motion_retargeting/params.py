...
ROBOT_XML_DICT = {
    ...
    "dm_prototype_v02": ASSET_ROOT / "dm_prototype_v02_zj01" / "xml" / "dm_prototype_v02_mocap.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "dm_prototype_v02": IK_CONFIG_ROOT / "smplx_to_dm_prototype_v02.json",
    },
    "bvh":{
